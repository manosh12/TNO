        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col sm:flex-row lg:mt-24 mt-5 mb-12 justify-center lg:gap-20 gap-5">
              <Link to="/" onClick={TopScroll} className="cursor-pointer text-gray-600 hover:text-white">HOME</Link>
              <Link to="/#intro" className="cursor-pointer text-gray-600 hover:text-white">ご挨拶</Link>
              <Link to="/company-info" onClick={TopScroll} className="cursor-pointer text-gray-600 hover:text-white">会社概要</Link>
              <Link to="/business-content" onClick={TopScroll} className="cursor-pointer text-gray-600 hover:text-white">業務内容</Link>
              <Link to="/#contact" className="cursor-pointer text-gray-600 hover:text-white">お問い合せ</Link>
            </div>
          </div>
